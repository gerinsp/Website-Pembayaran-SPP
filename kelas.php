...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		$sql = mysqli_query($koneksi,"SELECT kelas.kelas, kelas.th_pelajaran, count(kelas.nis) as jml, siswa.idprodi FROM kelas,siswa WHERE kelas.nis=siswa.nis AND th_pelajaran='2016/2017' GROUP BY kelas.kelas");
